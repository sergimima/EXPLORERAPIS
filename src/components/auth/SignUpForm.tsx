      ...
      <form onSubmit={handleSubmit} className="bg-card shadow-md rounded-lg px-8 pt-6 pb-8 mb-4 border border-border">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="shadow appearance-none border border-input rounded w-full bg-background py-2 px-3 text-foreground leading-tight focus:outline-none focus:shadow-outline"
            required
            disabled={isLoading}
          />
        </div>
        ...
        <div className="mb-6">
          <label htmlFor="confirmPassword" className="block text-foreground text-sm font-bold mb-2">
          ...
          <input
            ...
            className="shadow appearance-none border border-input rounded w-full bg-background py-2 px-3 text-foreground mb-3 leading-tight focus:outline-none focus:shadow-outline"
            required
            minLength={8}
            disabled={isLoading}
          />
        ...
        <div className="text-center mt-6">
          <p className="text-muted-foreground text-sm">
            ¿Ya tienes cuenta?{' '}
            <a href="/auth/signin" className="text-primary hover:opacity-80 font-semibold">
              Inicia sesión
            </a>
          </p>
        </div>
